...
contextBridge.exposeInMainWorld('gitFinder', {
  ...
  relationshipBoards: {
    ...
    attachFiles: request => ipcRenderer.invoke('whiteboards:attachFiles', request),
    getAssets: id => ipcRenderer.invoke('whiteboards:assets', id),
    revealAsset: request => ipcRenderer.invoke('whiteboards:revealAsset', request),
    listDocuments: () => ipcRenderer.invoke('whiteboards:list'),
    openDocument: id => ipcRenderer.invoke('whiteboards:open', id),
    saveDocument: request => ipcRenderer.invoke('whiteboards:save', request),
    exportPackage: request => ipcRenderer.invoke('whiteboards:exportPackage', request),
    importPackage: () => ipcRenderer.invoke('whiteboards:importPackage'),
    removeDocument: request => ipcRenderer.invoke('whiteboards:remove', request),
    pickImage: () => ipcRenderer.invoke('whiteboards:pickImage'),
  ...
  panel: {
    ...
    update: (values) => ipcRenderer.invoke('panel:update', values),
    ...
    getRemoteObservations: () => ipcRenderer.invoke('panel:getRemoteObservations'),
    getSyncLog: () => ipcRenderer.invoke('panel:getSyncLog'),
    openSyncLog: () => ipcRenderer.invoke('panel:openSyncLog'),
    ...
    setRepositoryAssociation: (values) => ipcRenderer.invoke('panel:setRepositoryAssociation', values),
    getLocalRepositories: () => ipcRenderer.invoke('panel:getLocalRepositories'),
    ...
    openExternal: (url) => ipcRenderer.invoke('panel:openExternal', url)
  },
  ...
  updater: {
    ...
    setPrerelease: (enabled) => ipcRenderer.invoke('updater:set-prerelease', enabled),
    setAutoInstall: (enabled) => ipcRenderer.invoke('updater:set-auto-install', enabled),
    feedback: () => ipcRenderer.invoke('updater:feedback'),
