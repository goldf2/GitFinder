...
test('目录操作、右键菜单、系统文件菜单和受信桥完整接入终端入口', () => {
  ...
  assert.ok(registry.CONTROLLER_NAMESPACES.includes('DirectoryTerminalController'));
  assert.deepEqual(registry.DELEGATE_MAP.openSelectedInTerminal, ['directoryTerminalController', 'open']);
