...
const ignoredSource = /^\/(?:dist|\.git|\.github|\.trae|test|docs|management|scripts|resources|prototypes)(?:$|\/)|^\/(?:AGENTS\.md|ARCHITECTURE\.md|CODEX_MEMORY\.md|CODEX_RELEASE_VALIDATION\.md|CONTEXT\.md|README\.md|\.gitignore|\.git-monitor-cache\.json)$|^\/public\/icon-master\.png$|(?:^|\/)\.DS_Store$/;
