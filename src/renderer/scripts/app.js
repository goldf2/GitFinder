...
const App = {
  ...
  panelDeploymentController: null,
  ...
  async init() {
    ...
    this.setupPanelDeploymentController();
  ...
  setupPanelDeploymentController() {
    this.panelDeploymentController = new window.PanelDeploymentController.Controller({
      app: this,
      bridge: window.gitFinder,
      document
    });
